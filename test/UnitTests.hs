...
-- Expressions to test
argEvalRunDecl1 = unDaisonI $ runExpr' "test = 3"
argEvalRunDecl2 = unDaisonI $ runExpr' "[a,b,c] = [1,2,3]"
argEvalRunDecl3 = unDaisonI $ runExpr' "[ ((a)) , (_,b) , _ ] = [(1,2),(3,4),(5,6)]"
argEvalRunDecl4 = unDaisonI $ runExpr' "_ = 1+2"
